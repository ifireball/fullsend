...
- [x] **Step 2b (2026-04-29): Org dashboard repo Onboard + R2** — Wired **Onboard** for **R1** / **R6** / **config_disabled** (enrollment PR + optional dispatch secret repo list update + `config.yaml` edits for R6 / disabled). **R2** row when an open enrollment PR exists per [2026-04-29 spec](../specs/2026-04-29-admin-spa-org-dashboard-repo-onboard.md). **Remove** / **Repair** / **R3** / **R5** remain future work.
